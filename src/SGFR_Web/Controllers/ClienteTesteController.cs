...
{
    public class ClienteTesteController : Controller
    {
        private readonly DbContextoGeral _context;

        public ClienteTesteController(DbContextoGeral context)
        {
            _context = context;
        }
        ...
        // GET: ClienteTeste/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ClienteTeste/Create
